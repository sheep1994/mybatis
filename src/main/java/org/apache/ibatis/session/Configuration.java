...
public class Configuration {
  ...
  /**
   * 指定mybatis所用VFS的具体实现，未指定将自动查找
   */
  protected Class<? extends VFS> vfsImpl;
  /**
   * mybatis一级缓存机制，默认作用域是sqlSession级别，还可以改变作用域为statement
  ...
  public Executor newExecutor(Transaction transaction, ExecutorType executorType) {
    ...
    // 使用了装饰器模式
    // mybatis默认是开启缓存的，因此会new CachingExecutor执行器
    if (cacheEnabled) {
